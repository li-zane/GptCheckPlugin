...
class Sub2ApiTodayCostsTests(unittest.TestCase):
    def test_accepts_supported_cost_field_aliases(self) -> None:
        payload = {
            ...
            "data": {
                "stats": {
                    ...
                    "8": {"actual_cost": 6, "cost": 8, "user_cost": 10},
                }
            },
        }

        self.assertEqual(
            _parse_account_today_costs(payload, {1, 2, 3, 4, 5, 6, 7, 8}),
            {
                1: 1.25,
                2: 2.5,
                3: 3.0,
        ...
        self.assertEqual(
            _parse_account_today_stats(payload, {1, 2, 3, 4, 5, 6, 7, 8}),
            {
    ...
    def test_parses_historical_actual_costs_by_date(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "2026-07-25": {"cost": 6.0, "user_cost": 10.0},
